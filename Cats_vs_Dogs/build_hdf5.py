...
from pyutils.preprocessing.aspectawarepreprocessor import AspectAwarePreprocessor
from pyutils.io.hdf5datasetwriter import HDF5DatasetWriter
...
print("Config image paths:", config.IMAGES_PATH)
